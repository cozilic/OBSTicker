            ...
            <div className="flex flex-1 flex-col gap-4 p-4">
                ...
                <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
                    <StatCard
                        ...
                        description={`${stats.playingMessages} ${t('playingNow')}`}
                        icon={MessageSquare}
                    />
                    <StatCard
                        title={t('todaysSubmissions')}
                        value={stats.todaysSubmissions}
                        description={t('todaysSubmissionsDescription')}
                        icon={RadioTower}
                    />
                    <StatCard
                        title={t('activeRss')}
                        value={stats.activeRssFeeds}
                        description={t('activeRssDescription')}
                        icon={Rss}
                    />
                    <StatCard
                        title={t('moderators')}
                        value={stats.moderators}
                        description={`${stats.playedMessages} ${t('messagesHavePlayed')}`}
                        icon={Users}
                    />
                </div>

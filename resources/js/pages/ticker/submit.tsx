                        ...
                        {requiresTwitchAuth && !isTwitchAuthenticated ? (
                            <div className="flex flex-col gap-4">
                                <div className="space-y-2">
                                    <h2 className="text-lg font-medium text-white">Twitch login required</h2>
                                    <p className="text-sm leading-6 text-neutral-300">
                                        Connect with Twitch to submit a message. Your Twitch username will be used as the sender name.
                                    </p>
                                </div>
                                <Button asChild className="h-11 w-fit bg-[#9146FF] text-white hover:bg-[#7c3aed]">
                                    ...
                                    <>
                                        <div className="grid gap-2">
                                            ...
                                            <Input
                                                ...
                                                placeholder={isTwitchAuthenticated ? 'Twitch username' : 'Optional'}
                                            ...
                                            />
                                            {isTwitchAuthenticated && <p className="text-xs text-neutral-400">Using your Twitch username.</p>}
                                        </div>
                                        ...
                                        {!isTwitchAuthenticated && (
                                            <Button asChild variant="outline" className="h-11 w-fit border-white/15 bg-white/5 text-white hover:bg-white/10">
                                                <a href={connectUrl}>Connect with Twitch</a>
                                            </Button>
                                        )}

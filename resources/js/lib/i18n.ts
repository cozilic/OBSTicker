...
const messages = {
    en: {
        ...
        officialThemesOnly: 'Theme submissions are available only on the official catalog site.',
        rejectionReasonPrompt: 'Rejection reason (optional)',
        deleteThemeSubmissionConfirm: 'Delete this theme submission? This cannot be undone.',
    ...
    sv: {
        ...
        officialThemesOnly: 'Temainskick finns bara på den officiella katalogsidan.',
        rejectionReasonPrompt: 'Orsak till avslag (valfritt)',
        deleteThemeSubmissionConfirm: 'Ta bort detta temainskick? Det går inte att ångra.',
        submittedAt: 'Skickad',
        done: 'Klar',
